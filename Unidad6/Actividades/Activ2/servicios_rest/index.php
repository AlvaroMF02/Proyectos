...
// Nos devuelve verdadero si ya existe el valor en una columna de una tabla al insertar
$app->get("/repetido/{tabla}/{columna}/{valor}", function ($request) {
    echo json_encode(repetido($request->getAttribute("tabla"), $request->getAttribute("columna"), $request->getAttribute("valor")));
});

// Nos devuelve verdadero si ya existe el valor en una columna de una tabla al editar
