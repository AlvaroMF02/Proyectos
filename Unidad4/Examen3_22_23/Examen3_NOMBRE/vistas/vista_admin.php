...
// VISTA DEL ADMINISTRADOR AL HACER LOGIN

// al pulsar cada boton te dice lo que ha hecho cada uno 
...
<body>
    ...
    // cojo los datos de todos los clientes
    try {
    ...
    <br>
    <?php
    // si pulsas insertar te muestra todo el formulario para la insercion
    ...
    <?php
    // si no te muestra el boton para insertar
    } else {
    ?>
